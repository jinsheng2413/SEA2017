...
class MServiceCallStatus2Page(Page):
    ...
    def inputSel_business_system(self, value):
        ...
        locator = self.get_select_locator(MServiceCallStatus2Locators.QRY_BUSINESS_SYSTEM_VALUE, value)
        self.click(*locator)

    # 服务名称
    def inputSel_business_name(self, value):
        self.click(*MServiceCallStatus2Locators.QRY_BUSINESS_NAME)
        locator = self.get_select_locator(MServiceCallStatus2Locators.QRY_BUSINESS_NAME_VALUE, value)
        self.click(*locator)
