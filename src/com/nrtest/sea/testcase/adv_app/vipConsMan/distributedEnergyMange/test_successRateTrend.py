...
@ddt
class TestSuccessRateTrend(unittest.TestCase, SuccessRateTrendPage):
    @classmethod
    def setUpClass(cls):
        print('开始执行')
        # 打开菜单（需要传入对应的菜单编号）
    ...
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyQuality_para, tabName='采集成功率趋势'))
