...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointTotalTime.py
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointTotalTimePage


# 统计查询→综合查询→单户综合查询--统计数据：测量点不平衡度越限累计时间统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointTotalTimePage):
