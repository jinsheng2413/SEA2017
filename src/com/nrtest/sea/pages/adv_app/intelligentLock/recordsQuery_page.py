...
# 开关锁操作日志
    ...
    def inputSel_cons_type(self,index):
        ...
        locator = self.get_select_locator(RecordsQueryLocators.CONS_TYPE_VALUE, index)
        self.click(*locator)
    # 操作行为
    def inputSel_operant_hehavior(self,index):
        self.click(*RecordsQueryLocators.OPERANT_HEHAVIOR)
        locator = self.get_select_locator(RecordsQueryLocators.OPERANT_HEHAVIOR_VALUE, index)
        self.click(*locator)
    # 操作结果
    def inputSel_operant_result(self,index):
        self.click(*RecordsQueryLocators.OPERANT_RESULT)
        locator = self.get_select_locator(RecordsQueryLocators.OPERANT_RESULT_VALUE, index)
        self.click(*locator)
    # 电子钥匙编号
