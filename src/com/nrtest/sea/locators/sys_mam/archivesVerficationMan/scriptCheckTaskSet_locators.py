...
class ScriptCheckTaskSetLocators:
    ...
    # 脚本类型
    QRY_SCRIPT_TYPE = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'脚本类型')]/../../div[1]/div[1]//input")
    QRY_SCRIPT_TYPE_VALUE = (
        By.XPATH,
        "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'计量关键业务数据核查')]/../..//div[contains(text(),'%s')]")
    # 脚本名称
    QRY_SCRIPT_NAME = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'脚本名称')]/../../div[1]/div[1]//input")
    # 创建员工
