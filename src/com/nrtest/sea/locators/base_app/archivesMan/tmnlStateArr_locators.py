...
class TmnlStateArrLocators:
    ...
    #终端状态
    QRY_TMNL_STATUS = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'终端状态')]/../../div[1]/div[1]//input")
    QRY_TMNL_STATUS_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'停运')]/../div[contains(text(),'%s')]")
    #统计日期
    QRY_COUNT_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'统计日期')]/../../div[1]/div[1]//input")
