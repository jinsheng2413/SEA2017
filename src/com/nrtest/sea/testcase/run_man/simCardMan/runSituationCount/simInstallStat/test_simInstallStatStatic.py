...
@file: test_simInstallStatStatic.py
...
class TestSimInstallStat(TestCase, SimInstallStatPageStatic):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(SimCardManData.para_simInstallStat_static)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SimCardManData.para_simInstallStat,
                                  SimCardManData.para_simInstallStat_static, valCheck=True))
