...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointDcSimulation.py
@time:2019/2/27 14:07
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointDcSimulationPage


# 统计查询→综合查询→单户综合查询--统计数据：测量点直流模拟量越限统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointDcSimulationPage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointDcSimulation_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:测量点直流模拟量越限统计
        """
