...
from com.nrtest.sea.pages.run_man.collegeywplat.lowPowerFaultDeal.lowPowerFaultDeal_page import FaultLowPowerMyTodoPage
...
class TestFaultSpecificPowerDeal(TestCase, FaultLowPowerMyTodoPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(AcquistionFaultHandling_data.para_lowPowerFaultMy_todo)
