...
@file: test_spVoltAnalyseStatic.py
...
class TestSpVoltAnalyseStatic(TestCase, SpVoltAnalyseStaticPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(TradnsformerMonitorData.para_SpVoltAnalyse_static)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(TradnsformerMonitorData.para_SpVoltAnalyse,
                                  TradnsformerMonitorData.para_SpVoltAnalyse_static, valCheck=True))
