...
class TestTerminalVersion(TestCase, TerminalVersionPage):
    ...
    def setUpClass(cls):
        ...
        # 打开菜单（需要传入对应的菜单编号）
        menuPage = MenuPage.openMenu(DataGatherMan_data.terminalVersion_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(DataGatherMan_data.terminalVersion_para, valCheck=True))
