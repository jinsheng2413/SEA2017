...
@ddt
class TestDistributedEnergyLoadMonitorDetail(TestCase, DistributedEnergyLoadMonitorDetailPage):
    @classmethod
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(DistributedEnergyMange_data.DistributedEnergyLoadMonitor_tabName_Detail)
