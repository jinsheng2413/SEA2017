...
# 人员处理明细
@ddt
class TestDemo(unittest.TestCase, StaffDealDetailPage):
    ...
    def setUpClass(cls):
        ...
        clickTabPage('人员处理明细')
        sleep(2)
        cls.driver.execute_script(StaffDealDetailLocators.QUERY_DATE_JS)
    ...
    def query(self, para):
        ...
        self.sleep_time(2)
        # 校验
        result = self.assert_context(*StaffDealDetailLocators.TABLE_DATA)
        self.assertTrue(result)

    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(OperOrganManData.para_FaultDealQualityEval, '人员处理明细'))
