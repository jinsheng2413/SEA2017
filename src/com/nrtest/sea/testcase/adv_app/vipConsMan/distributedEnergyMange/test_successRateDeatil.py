...
@ddt
class TestSuccessRateDetail(TestCase, SuccessRateDetailPage):
    @classmethod
    def setUpClass(cls):
        print('开始执行')
        ...
        menuPage.clickTabPage(DistributedEnergyMange_data.DistributedEnergyQuality_tabName_Detail)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyQuality_para,
                                  DistributedEnergyMange_data.DistributedEnergyQuality_tabName_Detail, valCheck=True))
