...
class ArchivesMaintain_locators:
    ...
    QRY_FACTORY_NAME_VALUE = (By.XPATH,"//div[@class=\"x-combo-list-inner\"]//div[contains(text(),'--全部--')]/../div[%s]")
    #电压等级
    ...
    BTN_METER_QRY = (By.XPATH, "(//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder x-column-layout-ct\"]//button[contains(text(),'查询')])[2]")
