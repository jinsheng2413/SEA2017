...
class DataStrategyManagenmentLocators:
    # 【查询条件区】

    # 存储周期
    QRY_STORAGE_CYCLE = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'存储周期')]/../../div[1]/div[1]//img")
    QRY_STORAGE_CYCLE_VALUE = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'一直保留')]/../div[contains(text(),'%s')]")
    # 表名称
    QRY_LIST_NAME = (
