...
class AssetManLocators:
    ...
    #锁封资产状态
    LOCK_ASSET_STATUS = (By.XPATH,'//label[contains(text(),"锁封资产状态")]/../div/div/input')
    # 锁封资产状态→值
    LOCK_ASSET_STATUS_VALUE = (By.XPATH,'(//div[@class="x-combo-list-inner"])[2]/div[%s]')
    # 锁封状态
    LOCK_STATUS = (By.XPATH, '//label[contains(text(),"锁封状态")]/../div/div/input')
    # 锁封状态→值
    LOCK_STATUS_VALUE = (By.XPATH, '(//div[@class="x-combo-list-inner"])[3]/div[%s]')
    # 锁封类型
    LOCK_TYPE = (By.XPATH, '//label[contains(text(),"锁封类型")]/../div/div/input')
    # 锁封类型→值
    LOCK_TYPE_VALUE = (By.XPATH, '(//div[@class="x-combo-list-inner"])[4]/div[%s]')
    # 查询按钮
