...
class TestBcVoltMonitorPointQuery(unittest.TestCase, OrgLowVoltDayStaticPage):
    ...
    def setUpClass(cls):
        ...
        # 点击Tab页标签
        clickTabPage(TradnsformerMonitorData.para_OrgLowVoltDayStatic)
        cls.exec_script(cls, OrgLowVoltDayStaticLocators.START_DATE_JS)
        cls.exec_script(cls, OrgLowVoltDayStaticLocators.END_DATE_JS)
