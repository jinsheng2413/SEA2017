...
class TmnlPowerCutEventQueryMonthLocators:
    ...
    # 月份
    QRY_DATE = (
        By.XPATH, '(//label[contains(text(),"月份")]/../div/div/input)[2]')
    # 停电次数
    QRY_POWER_CUT_TIME = (
        By.XPATH, '//label[contains(text(),"停电次数")]/../div/input')
    # 终端厂家
    QRY_TMNL_FACTORY = (
...
class TmnlPowerCutEventQueryDayLocators:
    ...
    # 停复电标识
    QRY_POWER_CUT_IDENTIFYING = (
        By.XPATH, '//label[contains(text(),"停复电标识")]/../div/div/img')
    QRY_POWER_CUT_IDENTIFYING_VALUE = (
        By.XPATH, '//div[@class="x-combo-list-inner"]/div[%s]')
    # 终端厂家
    QRY_TMNL_FACTORY = (
        By.XPATH, '//label[contains(text(),"终端厂家")]/../div/div/img')
