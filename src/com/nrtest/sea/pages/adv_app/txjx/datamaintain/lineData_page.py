...
from com.nrtest.sea.locators.adv_app.txjx.datamaintain.lineData_locators import LineDataLocators
...
class LineDataPage(Page):
    ...
    def inputSel_master(self, name):
        ...
        locator = self.get_select_locator(LineDataLocators.QRY_MASTER_VALUE, name)
        self.click(*locator)
