...
# 系统管理→日志管理→系统升级日志
@ddt
class TestSysUpgradeLog(TestCase, SysUpgradeLogPage):
    @classmethod
    def setUpClass(cls):
        # 打开菜单（需要传入对应的菜单编号）ljf
        menuPage = MenuPage.openMenu(LogEdit_data.sysUpgradeLog_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(LogEdit_data.sysUpgradeLog_para, valCheck=True))
