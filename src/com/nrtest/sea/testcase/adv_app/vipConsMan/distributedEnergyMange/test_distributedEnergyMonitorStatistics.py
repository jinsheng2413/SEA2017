...
@ddt
class TestDistributedEnergyMonitorStatistics(TestCase, DistributedEnergyMonitorStatisticsPage):
    @classmethod
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(DistributedEnergyMange_data.DistributedEnergyMonitor_tabName)
    ...
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyMonitor_para,
                                  DistributedEnergyMange_data.DistributedEnergyMonitor_tabName))
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyMonitor_para,
                                  DistributedEnergyMange_data.DistributedEnergyMonitor_tabName, valCheck=True))
