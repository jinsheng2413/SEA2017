...
class ImportantClientRealTimePowerCutMonitorLocators:
    # 电压等级
    QRY_VOLT_LEVEL = (By.XPATH, '(//label[contains(text(),"电压等级")]/../div/div/img)[2]')
    QRY_VOLT_LEVEL_VALUE = (By.XPATH, '//div[@class="x-combo-list-inner"]/div[%s]')
    # 停电开始日期
    QRY_START_DATE = (By.XPATH, '//label[contains(text(),"停电开始日期")]/../div/div/input')
    # 停电结束日期
    QRY_END_DATE = (By.XPATH, '//label[contains(text(),"停电结束日期")]/../div/div/input')
    # 查询按钮
