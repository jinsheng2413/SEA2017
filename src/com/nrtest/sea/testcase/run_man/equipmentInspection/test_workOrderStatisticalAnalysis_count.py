...
@file: test_workOrderStatisticalAnalysis_count.py
@time: 2019-02-14 10:32:54
@desc:
"""
...
from com.nrtest.sea.pages.run_man.equipmentInspection.workOrderStatisticalAnalysis_page import \
    WorkOrderStatisticalAnalysis_count_Page


@ddt
class test_WorkOrderStatisticalAnalysis_count(TestCase, WorkOrderStatisticalAnalysis_count_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(EquipmentInspection_data.workOrderStatisticalAnalysis_count_tab)
    ...
    @data(*DataAccess.getCaseData(EquipmentInspection_data.workOrderStatisticalAnalysis_para,
                                  EquipmentInspection_data.workOrderStatisticalAnalysis_count_tab))
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(EquipmentInspection_data.workOrderStatisticalAnalysis_para,
                                  EquipmentInspection_data.workOrderStatisticalAnalysis_count_tab, valCheck=True))
