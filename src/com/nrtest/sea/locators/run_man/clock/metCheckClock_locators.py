...
class MetClockMonthStaticLocators:
    ...
    # 电表类别-下拉框
    MET_TYPE_SEL = (By.XPATH, "(//div[@ class =\"x-form-item \"]//*[contains(text(),'电表类别')]/../div/div/img)[1]")
    # 电表类别
    MET_TYPE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'有功表')]/../div[contains(text(),'%s')]")
    # 电能表厂商-下拉框
    MET_FAC_SEL = (By.XPATH, "(//div[@ class =\"x-form-item \"]//*[contains(text(),'电能表厂商')]/../div/div/img)[1]")
    # 电能表厂商
    MET_FAC = (
...
class MetClockDayStaticLocators:
    ...
    # 电表类别-下拉框
    MET_TYPE_SEL = (By.XPATH, "(//div[@ class =\"x-form-item \"]//*[contains(text(),'电表类别')]/../div/div/img)[2]")
    # 电表类别
    MET_TYPE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'有功表')]/../div[contains(text(),'%s')]")
    # 电能表厂商-下拉框
    MET_FAC_SEL = (By.XPATH, "(//div[@ class =\"x-form-item \"]//*[contains(text(),'电能表厂商')]/../div/div/img)[2]")
    # 电能表厂商
    MET_FAC = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'ABB公司')]/../div[contains(text(),'%s')]")
    # 日期
...
class MetClockDetailLocators:
    ...
    MET_TYPE = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'有功表')]/../div[contains(text(),'%s')]")
    # 电能表资产号
    MET_ASSET_NO = (By.XPATH, "//div[@class=\"x-form-item \"]//*[contains(text(),'电能表资产号')]/../div/input")
    # 用户编号
    CONS_NO = (By.XPATH, "//div[@class=\"x-form-item \"]//*[contains(text(),'用户编号')]/../div/input")
    # 偏差范围-下拉框
...
class AutoCheckPolicyLocators:
    ...
    # 周期内自动对时次数
    AUTO_TIMES = (By.XPATH, "(//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'1')])[2]/../div[text()='%s']")
    # 自动对时开始日期
