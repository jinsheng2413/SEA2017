...
@file: test_hplcCollectFullRate_count.py
...
from com.nrtest.sea.pages.base_app.archivesMan.hplcChipMan.hplcCollectFullRate_page import \
    HplcCollectFullRate_count_page
...
@ddt
class TesthplcCollectFullRate_count(TestCase,HplcCollectFullRate_count_page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(HPLCChipMan_data.hplcCollectFullRate_count_tab)
    ...
    @data(*DataAccess.getCaseData(HPLCChipMan_data.hplcCollectFullRate_para,HPLCChipMan_data.hplcCollectFullRate_count_tab))
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(HPLCChipMan_data.hplcCollectFullRate_para,HPLCChipMan_data.hplcCollectFullRate_count_tab, valCheck=True))
