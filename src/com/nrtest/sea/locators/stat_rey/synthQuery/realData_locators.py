...
class RealDataLocators:
    ...
    # 电表资产号
    QRY_METER_ASSET_NO_RDETAIL = (
        By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'电表资产号')]/../../div[1]/div[1]//input)[1]")
    ...
    QRY_TMNL_MANUFACTUREE_VALUE = (
        By.XPATH,
        "//div[@class=\"x-layer x-combo-list \"]//div[contains(text(),'反向采集失败')]/../div[contains(text(),'全部')]")

    # 反向采集结果
    QRY_REVERS_COLLECT_RESULT = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'反向采集结果')]/../../div[1]/div[1]//input")
    QRY_REVERS_COLLECT_RESULT_VALUE = (
        By.XPATH, "//div[@class=\"x-layer x-combo-list \"]//div[contains(text(),'东方电子')]/../div[contains(text(),'%s')]")
    # 相位
    QRY_PHASE_RDETAIL = (
