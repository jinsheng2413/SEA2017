...
class RecordsQueryLocators:
    ...
    # 操作员名称
    STAFF_NAME = (
        By.XPATH, '//label[contains(text(),"操作员名称")]/../div/div/input')
    # 台区编号
    ...
    # 操作行为
    OPERANT_HEHAVIOR = (
        By.XPATH, '//label[contains(text(),"操作行为")]/../div/div/input')
    # 操作行为→值
    OPERANT_HEHAVIOR_VALUE = (
        By.XPATH, '(//div[@class="x-combo-list-inner"])[2]/div[%s]')
    # 操作结果
    OPERANT_RESULT = (
        By.XPATH, '//label[contains(text(),"操作结果")]/../div/div/input')
    # 操作结果→值
    OPERANT_RESULT_VALUE = (
    ...
    # 操作员名称
    TAB_STAFF_NAME = (
        By.XPATH, '(//label[contains(text(),"操作员名称")]/../div/div/input)[2]')
    # 电子钥匙编号
    TAB_KEY_NO = (
        By.XPATH, '(//label[contains(text(),"电子钥匙编号")]/../div/div/input)[2]')
    # 锁封编号
    TAB_LOCK_NO = (
        By.XPATH, '(//label[contains(text(),"锁封编号")]/../div/div/input)[2]')
    # 锁封用户编号
    TAB_LOCK_USER_NO = (
        By.XPATH, '//label[contains(text(),"锁封用户编号")]/../div/div/input')
    # 开始日期
    TAB_START_DATE = (
        By.XPATH, '(//label[contains(text(),"开始日期")]/../div/div/input)[2]')
    # 结束日期
    TAB_END_DATE = (
        By.XPATH, '(//label[contains(text(),"结束日期")]/../div/div/input)[2]')
    # 查询按钮
