...
class CtrlExecutSpecLocators:
    ...
    #控制类型
    QRY_CONTROL_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'控制类型')]/../../div[1]/div[1]//input")
    ...
    #工单号
    QRY_WORK_ORDER = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'工单号')]/../../div[1]/div[1]//input")
