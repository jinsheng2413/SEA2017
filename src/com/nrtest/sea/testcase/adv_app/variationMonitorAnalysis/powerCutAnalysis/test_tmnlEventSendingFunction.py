...
class TestTmnlEventSendingFunction(TestCase, TmnlEventSendingFunctionPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(PowerCutAnalysis_data.TmnlEventSendingFunction_tabName)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.TmnlEventSendingFunction_para,
                                  PowerCutAnalysis_data.TmnlEventSendingFunction_tabName, valCheck=True))
