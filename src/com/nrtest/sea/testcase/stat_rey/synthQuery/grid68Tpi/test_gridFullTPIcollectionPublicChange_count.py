...
@file: test_gridFullTPIcollectionPublicChange_count.py
...
@ddt
class TestGridFullTPIcollectionPublicChangeCount(TestCase, GridFullTpiCollectionPublicChange_count_Page):
