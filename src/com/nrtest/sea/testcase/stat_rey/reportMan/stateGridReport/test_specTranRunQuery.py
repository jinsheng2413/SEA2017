...
from com.nrtest.sea.data.stat_rey.reportMan.stateGridReport.specTranRunQuery_data import SpecTranRunQuery_data
...
class TestSpecTranRunQuery(TestCase, SpecTranRunQueryPage):
    ...
    def setUpClass(cls):
        ...
        menuPage = MenuPage.openMenu(SpecTranRunQuery_data.SpecTranRunQuery_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SpecTranRunQuery_data.SpecTranRunQuery_para, valCheck=True))
