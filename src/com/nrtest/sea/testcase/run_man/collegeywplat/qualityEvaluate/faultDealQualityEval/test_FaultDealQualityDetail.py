...
@file: test_FaultDealQualityDetail.py
...
from com.nrtest.sea.pages.run_man.collegeywplat.qualityEvaluate.faultDealQualityEval_page import \
...
# 故障处理质量明细
@ddt
class TestFaultDealQualityDetail(TestCase, FaultDealQualityDetailPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(OperOrganManData.para_FaultDealQualityEval_detail)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(OperOrganManData.para_FaultDealQualityEval, OperOrganManData.para_FaultDealQualityEval_detail, valCheck=True))
