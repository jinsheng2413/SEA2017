...
from com.nrtest.sea.pages.adv_app.variationMonitorAnalysis.powerCutAnalysis.historyPowerCutEventQuery_page import \
    HistoryPowerCutEventQueryPage
from com.nrtest.sea.pages.other.menu_page import MenuPage


# 高级应用→配变监测分析→停电分析→历史停电事件查询:停电事件统计
@ddt
class TestHistoryPowerCutEventQuery(TestCase, HistoryPowerCutEventQueryPage):
    @classmethod
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(PowerCutAnalysis_data.HistoryPowerCutEventQuery_tabName)
    ...
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.HistoryPowerCutEventQuery_para,
                                  PowerCutAnalysis_data.HistoryPowerCutEventQuery_tabName))
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.HistoryPowerCutEventQuery_para,
                                  PowerCutAnalysis_data.HistoryPowerCutEventQuery_tabName, valCheck=True))
