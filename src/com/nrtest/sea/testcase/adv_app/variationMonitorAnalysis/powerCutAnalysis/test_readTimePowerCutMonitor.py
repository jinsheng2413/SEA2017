...
@ddt
class TestReadTimePowerCutMonitor(TestCase, ReadTimePowerCutMonitorPage):
    @classmethod
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(PowerCutAnalysis_data.ReadTimePowerCutMonitor_tabName)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.ReadTimePowerCutMonitor_para,
                                  PowerCutAnalysis_data.ReadTimePowerCutMonitor_tabName, valCheck=True))
