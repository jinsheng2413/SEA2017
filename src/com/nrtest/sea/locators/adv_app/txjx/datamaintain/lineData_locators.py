...
class LineDataLocators:
    # 【查询条件区】
    # 变电站
    QRY_TRANSFORMER_SUBSTATION = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'变电站')]/../../div[1]/div[1]//input")
    # 负责人
    QRY_MASTER = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'负责人')]/../../div[1]/div[1]//input")
    QRY_MASTER_VALUE = (
