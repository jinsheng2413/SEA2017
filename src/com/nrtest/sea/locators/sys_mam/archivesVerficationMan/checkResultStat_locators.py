...
class CheckResultStatLocators:
    #【查询条件区】
    #开始时间
    QRY_START_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'开始日期')]/../../div[1]/div[1]//input")
    #结束时间
    QRY_END_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'结束日期')]/../../div[1]/div[1]//input")
    #任务类型
    QRY_TASK_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'任务类型')]/../../div[1]/div[1]//input")
    QRY_TASK_TYPE_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'电网结构核查')]/../..//div[contains(text(),'%s')]")
    #异常类型
    QRY_EXCEPTION_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'异常类型')]/../../div[1]/div[1]//input")
    #台区编号
    QRY_ZONE_AREA_NO = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'台区编号')]/../../div[1]/div[1]//input")
