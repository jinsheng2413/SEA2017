...
from com.nrtest.sea.locators.adv_app.costControlManage.remoteCustControl.newPrePaidStatus_locators import NewPrePaidStatusLocators
...
class NewPrePaidStatusPage(Page):
    ...
    def inputRSel_controlType_one(self, name):
        ...
        locator = self.get_select_locator(NewPrePaidStatusLocators.QRY_CONTROL_TYPE_VALUE_ONE, name)
        print(locator)
        self.click(*locator)

    def inputRSel_controlType_Two(self, name):
        self.click(*NewPrePaidStatusLocators.QRY_CONTROL_TYPE_TWO)
        locator = self.get_select_locator(NewPrePaidStatusLocators.QRY_CONTROL_TYPE_VALUE_TWO, name)
        print(locator)
        self.click(*locator)
