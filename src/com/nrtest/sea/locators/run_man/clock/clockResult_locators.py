...
class ClockResultStaticLocators:
    ...
    # 开始时间
    QUERY_DATE = (By.XPATH, "(//div[@class=\"x-form-item \"]//*[contains(text(),'开始时间')])[1]/../div/div/input")
...
class ClockResultDetailLocators:
    ...
    # 电表资产号
    MET_ASSET_NO = (By.XPATH, "//div[@class=\"x-form-item \"]//*[contains(text(),'电表资产号')]/../div/input")
    # 终端资产号
    ...
    # 月份
    QUERY_DATE = (By.XPATH, "//div[@class=\"x-form-item \"]//*[contains(text(),'月            份:')]/../div/div/input")
