...
from com.nrtest.sea.pages.adv_app.costControlManage.remoteCustControl.newPrePaidStatus_page import \
    NewPrePaidStatusPage
from com.nrtest.sea.pages.other.menu_page import MenuPage


# 高级应用→费控管理→远程费控→新远程费控执行统计
@ddt
class TestNewPrePaidStatus(TestCase, NewPrePaidStatusPage):
    ...
    @data(*DataAccess.getCaseData(RemoteCustControl_data.NewPrePaidStatus_para, RemoteCustControl_data.Tab_ByAction))
