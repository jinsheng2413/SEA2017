...
class ArchivesChangeRecordLocators:
    ...
    # 设备类型
    QRY_DEVICE_TYPE = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'设备类型')]/../../div[1]/div[1]/div/img")
    QRY_DEVICE_TYPE_VALUE = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'电能表')]/../div[contains(text(),'%s')]")
    # 变更类型div/
    QRY_CHANGE_TYPE = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'变更类型')]/../../div[1]/div[1]/div/img")
    QRY_CHANGE_TYPE_VALUE = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'新增')]/../div[contains(text(),'%s')]")
    #
    QRY_START_TIME = (
        By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'开始日期')])[1]/../../div[1]/div[1]/div/input")
    #
    QRY_END_TIME = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'结束日期')]/../../div[1]/div[1]/div/input")
