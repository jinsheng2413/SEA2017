...
from com.nrtest.sea.pages.adv_app.transformerMonitor.powerFactorCount_page import PowerFactorCountDetailPage
...
class TestPowerFactorCountDetail(TestCase, PowerFactorCountDetailPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(TradnsformerMonitorData.para_PowerFactorCount_detail)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(TradnsformerMonitorData.para_PowerFactorCount,
                                  TradnsformerMonitorData.para_PowerFactorCount_detail, valCheck=True))
