...
@file: test_gridFullTPIcollectionOnlyChange_count.py
...
from com.nrtest.sea.pages.stat_rey.synthQuery.grid68Tpi.gridFullTPIcollectionOnlyChange_page import \
    GridFullTpiCollectionOnlychange_count_Page


@ddt
class test_GridFullTpiCollectionOnlychange(TestCase, GridFullTpiCollectionOnlychange_count_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(Grid68Tpi_data.gridFullTPIcollectionOnlyChange_count_tab)
    ...
    @data(*DataAccess.getCaseData(Grid68Tpi_data.gridFullTPIcollectionOnlyChange_para,
                                  Grid68Tpi_data.gridFullTPIcollectionOnlyChange_count_tab))
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(Grid68Tpi_data.gridFullTPIcollectionOnlyChange_para,
                                  Grid68Tpi_data.gridFullTPIcollectionOnlyChange_count_tab, valCheck=True))
