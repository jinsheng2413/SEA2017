...
@file: test_sysBasicParaSet.py
@time: 2018/11/16 14:13
@desc:
"""
...
class TestSysBasicParaSet(TestCase, SysBasicParaSetPage):
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SysConfigManData.SysParameterMan_para, SysConfigManData.SysBasicParaSet_tabName, valCheck=True))
