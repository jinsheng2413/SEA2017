...
@file: test_DataStructureComparison.py
...
class TestDataStructureComparison(TestCase, DataStructureComparisonPage):
    ...
    def setUpClass(cls):
        ...
        menuPage = MenuPage.openMenu(DataClearing_data.dataStructureComparison_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(DataClearing_data.dataStructureComparison_para, valCheck=True))
