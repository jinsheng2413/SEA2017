...
@file: test_intelligentMeterPowerCutEventQueryDetail.py
...
@ddt
class TestIntelligentMeterPowerCutEventQueryDetail(unittest.TestCase, IntelligentMeterPowerCutEventQueryDetailPage):
    @classmethod
    def setUpClass(cls):
        print("开始执行")
        # 打开菜单（需要传入对应的菜单编号）
        cls.driver = openMenu(PowerCutAnalysis_data.IntelligentMeterPowerCutEventQuery_para, True)
    ...
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.IntelligentMeterPowerCutEventQuery_para, tabName='智能表停电明细'))
