...
class TestWorkCount(TestCase, WorkCountPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(AppQuery_data.AppQuery_tab_count)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(AppQuery_data.AppQuery_para, AppQuery_data.AppQuery_tab_count, valCheck=True))
