...
@file: checkReduceManager_locators.py
@time: 2018/11/16 0016 15:24
@desc:
"""
from selenium.webdriver.common.by import By

# 系统管理--》档案核查管理--》考核减免管理
class CheckReduceManagerLocators:
    #【查询条件区】
    #开始日期
    ...
    #申请单号
    QRY_APPLY_NO = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'申请单号')]/../../div[1]/div[1]//input")
