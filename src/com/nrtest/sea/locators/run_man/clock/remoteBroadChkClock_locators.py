...
# 运行管理→时钟管理→远程广播校时设置
class RemoteBroadChkClockLocators:
    # 【查询条件】
    # 节点名称
    NODE = (
        By.XPATH, ("//div[@class=\"x-form-item \"]//*[contains(text(),'节点名称')]/../div/input"))
    # 终端地址
    TMNL_ADDR = (
        By.XPATH, "//div[@class=\"x-form-item \"]//*[contains(text(),'终端地址')]/../div/input")
    # 终端类型-下拉框
    TMNL_TYPE_SEL = (
        By.XPATH, "//div[@ class =\"x-form-item \"]//*[contains(text(),'终端类型')]/../div/div/img")
    # 终端类型
    TMNL_TYPE = (
    ...
    # 终端规约-下拉框
    TMNL_PROTOCOL_SEL = (
        By.XPATH, "//div[@ class =\"x-form-item \"]//*[contains(text(),'终端规约')]/../div/div/img")
    # 终端规约
    TMNL_PROTOCOL = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'698规约')]/../div[contains(text(),'%s')]")
    # 设置状态-下拉框
    SET_STATUS_SEL = (
        By.XPATH, "//div[@ class =\"x-form-item \"]//*[contains(text(),'设置状态')]/../div/div/img")
    # 设置状态
    SET_STATUS = (
