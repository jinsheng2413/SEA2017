...
@file: test_GatherTaskCompile_resultAnalysis.py
...
from com.nrtest.sea.pages.base_app.dataGatherMan.GatherTaskCompile_Page import GatherTaskCompile_result_Page
...
class TestGatherTaskCompile(TestCase, GatherTaskCompile_result_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(DataGatherMan_data.atherTaskCompile_tab_resultAnaylsis_task)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(DataGatherMan_data.gatherTaskCompile_para,
                                  DataGatherMan_data.atherTaskCompile_tab_resultAnaylsis_task, valCheck=True))
