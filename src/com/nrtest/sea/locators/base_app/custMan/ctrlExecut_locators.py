...
class CtrlExecutLocators:
    ...
    # 结束时间
    QRY_END_TIME = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'结束时间')]/../../div[1]/div[1]/div/input")
    # 工单号
    QRY_WORRK_ORDER = (
    ...
    # 确认状态
    QRY_CONFIRM_STATUS = (
        By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'确认状态')]/../../div[1]/div[1]/div/img")
