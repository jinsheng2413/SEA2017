...
@file: test_spVoltAnalyseDetail.py
...
from com.nrtest.sea.pages.adv_app.transformerMonitor.transformerVoltAnalyse.spVoltAnalyse_page import \
...
# 专/公变电压质量明细
@ddt
class TestSpVoltAnalyseDetail(TestCase, SpVoltAnalyseDetailPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(TradnsformerMonitorData.para_SpVoltAnalyse_detail)
    ...
    def test_query(self, para):
        """高级应用→配变监测分析→电压质量分析→专/公变电压质量分析:专/公变电压质量明细
        对查询结果有无、数据链接跳转等校验
        :param para: 用例数据
        """
