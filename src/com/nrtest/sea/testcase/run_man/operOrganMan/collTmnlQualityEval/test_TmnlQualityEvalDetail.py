...
# 终端质量评价明细
@ddt
class TestDemo(unittest.TestCase, TmnlQualityEvalDetailPage):
    ...
    def setUpClass(cls):
        ...
        cls.exec_script(cls, TmnlQualityEvalDetailLocators.QUERY_END_DATE_JS)
    ...
    def query(self, para):
        ...
        self.sleep_time(2)
        # 校验
        result = self.assert_context(*TmnlQualityEvalDetailLocators.TABLE_DATA)
        self.assertTrue(result)

    @BeautifulReport.add_test_img()
    @data(
        *DataAccess.getCaseData(OperOrganManData.para_CollTmnlQualityEval, OperOrganManData.para_TmnlQualityEvalDetail))
