...
@ddt
class TestUserCollectStatistics2017(TestCase, UserCollectStatistics2017Page):
    @classmethod
    def setUpClass(cls):
        # 打开菜单（需要传入对应的菜单编号）ljf
        menuPage = MenuPage.openMenu(CollConstructStatus_data.UserCollectStatistics2017_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(CollConstructStatus_data.UserCollectStatistics2017_para, valCheck=True))
