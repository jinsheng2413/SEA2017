...
class TestarchivesMaintain_meter(TestCase, ArchivesMaintain_meter_pages):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(ArchivesMan_data.archivesMenTain_meter_tab)
    ...
    def query(self, para):
        ...
        # 终端资产号
        self.inputStr_termainalAssetNo(para['TERMINAL_ASSET_NO'])
        # 终端地址
        self.inputStr_termainalAddr(para['TERMINAL_ADDR'])
