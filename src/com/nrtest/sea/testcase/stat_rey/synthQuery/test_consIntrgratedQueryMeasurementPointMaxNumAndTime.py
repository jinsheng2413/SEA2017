...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointMaxNumAndTime.py
@time:2019/2/27 14:09
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointMaxNumAndTimePage


# 统计查询→综合查询→单户综合查询--统计数据：测量点最大需量及发生时间统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointMaxNumAndTimePage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointMaxNumAndTime_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:测量点最大需量及发生时间统计
        """
