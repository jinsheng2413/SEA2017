...
class BackgroupServeMonitorPage(Page):
    ...
    def inputDt_date(self, content):
        ...
        self.inputDate(content, True)

    # 运行状态
    def inputSel_operation_stat(self, options):
        # self.click(*BackgroupServeMonitorLocators.QRY_OPERATION_STAT)
        # locator = self.get_select_locator(BackgroupServeMonitorLocators.QRY_OPERATION_STAT_VALUE, options)
        # self.click(*locator)
