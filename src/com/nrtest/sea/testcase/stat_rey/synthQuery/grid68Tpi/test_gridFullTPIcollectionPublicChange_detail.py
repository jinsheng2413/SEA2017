...
@file: test_gridFullTPIcollectionPublicChange_detail.py
...
@ddt
class TestGridFullTPIcollectionPublicChangeDetail(TestCase, GridFullTpiCollectionPublicChange_detail_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(Grid68Tpi_data.gridFullTPIcollectionPublicChange_detail_tab)
