...
class EventRecResultStatLocators:
    #【查询条件区】
    #起始日期
    QRY_START_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'起始日期')]/../../div[1]/div[1]//input")
    #
    QRY_END_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'终止日期')]/../../div[1]/div[1]//input")

    #事件类型
    QRY_EVENT_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'事件类型')]/../../div[1]/div[1]//img")
    QRY_EVENT_TYPE_VALUE = (By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'ERC1数据初始化和版本变更')]/../div[contains(text(),'%s')]")
