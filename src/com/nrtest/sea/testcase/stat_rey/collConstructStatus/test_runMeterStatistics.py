...
@file: test_runMeterStatistics.py
@time: 2018/10/25 15:16
@desc:
"""
...
class TestRunMeterStatistics(TestCase, RunMeterStatisticsPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(CollConstructStatus_data.RunMeterStatistics_tabName)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(CollConstructStatus_data.RunMeterStatistics_para,
                                  CollConstructStatus_data.RunMeterStatistics_tabName, valCheck=True))
