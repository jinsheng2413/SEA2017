...
#数据展示
    #查询日期_开始
    def inputdt_starttime(self,content):
        self.input(content,*LineDataQueryLocators.INPUTDT_STARTTIME)
    #查询日期_结束
    def inputdt_endtime(self,content):
        self.input(content,*LineDataQueryLocators.INPUTDT_ENDTIME)
    #查询按钮
