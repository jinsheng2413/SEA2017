...
class DistributedEnergyStatLocators:
    ...
    #发电量消纳方式
    QRY_POWER_CONSUMPTION_MODE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'发电量消纳方式')]/../../div[1]/div[1]//input")
    QRY_POWER_CONSUMPTION_MODE_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'全部自用')]/../div[contains(text(),'%s')]")
    #发电类型
    QRY_POWER_MODE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'发电类型')]/../../div[1]/div[1]//input")
