...
from com.nrtest.sea.pages.run_man.simCardMan.runSituationCount.simAlarmAnaly_page import AbnormalDetailPage, AbnormalDetailLocators
...
class TestDemo(unittest.TestCase,AbnormalDetailPage):
    ...
    def query(self, para):
        ...
        #异常类型
        self.inputStr_AbnormalType(para['ABNORMAL_TYPE'])
    ...
    @data(*DataAccess.getCaseData(RunSituationCount_data.simAlarmAnaly_para,RunSituationCount_data.simAlarmAnaly_tab_detail))
