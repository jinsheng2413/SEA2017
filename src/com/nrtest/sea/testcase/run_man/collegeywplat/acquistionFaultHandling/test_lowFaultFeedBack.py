...
from com.nrtest.sea.pages.collegeywplat.acquistionFaultHandling.lowFaultHandler_page import LowFaultFeedBackPage, LowFaultFeedBackLocators
from com.nrtest.sea.task.commonMath import *


# 运行管理-->采集运维平台-->采集故障处理-->低压故障处理
@ddt
class TestLowFaultFeedback(unittest.TestCase,LowFaultFeedBackPage):
    ...
    @data(*DataAccess.getCaseData(AcquistionFaultHandling_data.lowFaultHandler_para,AcquistionFaultHandling_data.lowFaultHandler_tab_feedback))
