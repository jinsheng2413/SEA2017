...
class BatchFetchLocators:
    #【查询条件区】
    #任务名称
    QRY_TASK_NAME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'任务名称')]/../../div[1]/div[1]//input")
    #操作人
    QRY_PERFORMER = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'操作人')]/../../div[1]/div[1]//input")

    #有效性
    QRY_EFFECTIVENESS = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'有效性')]/../../div[1]/div[1]//input")
