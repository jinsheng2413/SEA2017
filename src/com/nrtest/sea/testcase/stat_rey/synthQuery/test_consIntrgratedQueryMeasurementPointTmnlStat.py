...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointTmnlStat.py
@time:2019/2/27 14:12
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointTmnlStatPage


# 统计查询→综合查询→单户综合查询--统计数据：终端统计数据
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointTmnlStatPage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointTmnlStat_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:终端统计数据
        """
