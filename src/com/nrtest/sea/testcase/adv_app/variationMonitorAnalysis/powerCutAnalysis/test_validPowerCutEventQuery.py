...
class TestValidPowerCutEventQuery(TestCase, ValidPowerCutEventQueryPage):
    ...
    def setUpClass(cls):
        ...
        menuPage = MenuPage.openMenu(PowerCutAnalysis_data.ValidPowerCutEventQuery_para)
        super(TestCase, cls).__init__(cls, menuPage.driver, menuPage)
        # 菜单页面没多个Tab页时，请注释clickTabPage所在行代码
        menuPage.clickTabPage(PowerCutAnalysis_data.ValidPowerCutEventQuery_tabName)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(PowerCutAnalysis_data.ValidPowerCutEventQuery_para,
                                  PowerCutAnalysis_data.ValidPowerCutEventQuery_tabName, valCheck=True))
