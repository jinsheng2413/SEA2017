...
@file: test_distributedEnergyElectricDetail.py
@time: 2018/11/9 17:25
@desc:
"""
...
from com.nrtest.sea.pages.adv_app.vipConsMan.distributedEnergyMange.distributedEnergyElectricMonitor_page import \
    DistributedEnergyElectricDetailPage
from com.nrtest.sea.pages.other.menu_page import MenuPage


# 高级应用→重点用户监测→分布式电源管理→分布式电源电量监测:分布式电源电量监测明细
@ddt
class TestDistributedEnergyElectricDetail(TestCase, DistributedEnergyElectricDetailPage):
    @classmethod
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(DistributedEnergyMange_data.DistributedEnergyElectricMonitor_tabName_Detail)
    ...
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyElectricMonitor_para,
                                  DistributedEnergyMange_data.DistributedEnergyElectricMonitor_tabName_Detail))
