...
@file: test_xlLineLossModel_loss.py
@time: 2019-02-20 12:22:47
@desc:
"""
...
from com.nrtest.sea.pages.adv_app.lineLossAnalysis.lineLossMantain.xlLineLossModel_page import XlLineLossModel_loss_Page
...
class test_XlLineLossModel(TestCase, XlLineLossModel_loss_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(LineLossMantain_data.xlLineLossModel_loss_tab)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(LineLossMantain_data.xlLineLossModel_para,
                                  LineLossMantain_data.xlLineLossModel_loss_tab, valCheck=True))
