...
# 终端手工对时
@ddt
class TestTmnlManualCheck(TestCase,Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(ClockData.para_TTmnlCheckClock_manual)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(ClockData.para_TTmnlCheckClock,
                                  ClockData.para_TTmnlCheckClock_manual, valCheck=True))
