...
from com.nrtest.sea.pages.collegeywplat.acquistionFaultHandling.faultHandler_page import FaultFeedBackPage, FaultFeedBackLocators
from com.nrtest.sea.task.commonMath import *


#运行管理-->采集运维平台-->采集故障处理-->专变故障处理
@ddt
class TestFaultFeedback(unittest.TestCase,FaultFeedBackPage):
    ...
    @data(*DataAccess.getCaseData(AcquistionFaultHandling_data.faultHandler_para,AcquistionFaultHandling_data.faultHandler_tab_feedback))
