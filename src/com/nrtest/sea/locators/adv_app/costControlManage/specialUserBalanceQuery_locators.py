...
class SpecialUserBalanceQuery_locators:
    ...
    # 终端地址
    QRY_TERMINAL_ADDR = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'终端地址')]/../../div[1]/div[1]/input")
    #越线类型
    QRY_MORE_BOARD_CATA = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'越限类型')]/../div[1]/div/img")
    QRY_MORE_BOARD_CATA_VALUE = (By.XPATH, "//div[@class=\"x-combo-list-inner\"]//div[contains(text(),'低于告警电量')]/../div[%s]")

    #召测日期
    QRY_CALL_TEST_DATE = (By.XPATH,"//div[@class=\"x-form-item \"]//label[contains(text(),'召测日期')]/../../div[1]/div[1]/div/input")
    #【显示区】
