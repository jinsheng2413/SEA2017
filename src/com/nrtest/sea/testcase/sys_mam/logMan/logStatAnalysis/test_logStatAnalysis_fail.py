...
# 月统计登录失败top50
@ddt
class TestLogStatAnalysis_fail(TestCase, LogStatAnalysis_fial_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(LogEdit_data.logStatAnalysis_tab_fail)
