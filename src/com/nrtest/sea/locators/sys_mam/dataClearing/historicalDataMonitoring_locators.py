...
class HistoricalDataMonitoringLocators:
    ...
    #数据组
    QRY_DATA_GROUP = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'数据组')]/../../div[1]/div[1]//img")
    ...
    #截至日期
    QRY_END_DATE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'截止日期')]/../../div[1]/div[1]//input")
