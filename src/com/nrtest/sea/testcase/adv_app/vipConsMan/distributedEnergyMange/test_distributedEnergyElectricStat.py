...
@file: test_distributedEnergyElectricStat.py
@time: 2018/11/9 17:20
@desc:
"""
...
from com.nrtest.sea.pages.adv_app.vipConsMan.distributedEnergyMange.distributedEnergyElectricMonitor_page import \
    DistributedEnergyElectricStatPage
from com.nrtest.sea.task.commonMath import *


# 高级应用→重点用户监测→分布式电源管理→分布式电源电量监测→分布式电源电量监测统计
@ddt
class TestDistributedEnergyElectricStat(TestCase, DistributedEnergyElectricStatPage):
    @classmethod
    def setUpClass(cls):
        print('开始执行')
        ...
        menuPage.clickTabPage(DistributedEnergyMange_data.DistributedEnergyElectricMonitor_tabName_Stat)
    ...
    @data(*DataAccess.getCaseData(DistributedEnergyMange_data.DistributedEnergyElectricMonitor_para,
                                  DistributedEnergyMange_data.DistributedEnergyElectricMonitor_tabName_Stat))
