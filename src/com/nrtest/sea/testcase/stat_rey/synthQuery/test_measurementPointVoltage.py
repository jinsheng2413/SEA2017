...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointVoltagePage


# 统计查询→综合查询→单户综合查询--统计数据：测量点电压统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointVoltagePage):
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointVoltage_tab, valCheck=True))
