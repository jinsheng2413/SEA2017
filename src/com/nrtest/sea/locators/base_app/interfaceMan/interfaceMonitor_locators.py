...
class InterfaceMonitor_Locators:
    ...
    #接口类型
    QRY_INTERFACE_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'接口类型')]/../../div[1]/div[1]//img")
    QRY_INTERFACE_TYPE_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'调度系统')]/../div[contains(text(),'%s')]")
    #接口日期从
    QRY_START_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'接口日期从')]/../../div[1]/div[1]//input")
    #到
