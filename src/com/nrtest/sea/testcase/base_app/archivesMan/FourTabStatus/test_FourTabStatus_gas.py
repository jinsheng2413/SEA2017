...
@file: test_FourTabStatus_gas.py
...
class TestFourTabStatus(TestCase, FourTabStatusPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(ArchivesMan_data.fourTabStatus_gas_tab, is_by_js=True)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(ArchivesMan_data.fourTabStatus_para,
                                  ArchivesMan_data.fourTabStatus_gas_tab, valCheck=True))
