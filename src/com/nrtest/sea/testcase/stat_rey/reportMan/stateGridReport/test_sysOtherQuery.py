...
class TestSysOtherQuery(TestCase, SysOtherQueryPage):
    ...
    def setUpClass(cls):
        ...
        menuPage = MenuPage.openMenu(SysOtherQuery_data.SysOtherQuery_para)
    ...
    def query(self, para):
        ...
        # 查询日期
        self.inputDt_query_dateS(para['DATE'])
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SysOtherQuery_data.SysOtherQuery_para, valCheck=True))
