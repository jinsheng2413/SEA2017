...
# 统计查询→综合查询→线路拓扑图
@ddt
class TestLineTopologyDiagram(TestCase, LineTopoLogyDiagramPage):
    @classmethod
    def setUpClass(cls):
        # 打开菜单（需要传入对应的菜单编号）ljf
        menuPage = MenuPage.openMenu(SynthQuery_data.LineTopologyDiagram_para)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SynthQuery_data.LineTopologyDiagram_para, valCheck=True))
