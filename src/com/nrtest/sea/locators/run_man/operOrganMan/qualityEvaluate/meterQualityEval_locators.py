...
# 电表质量评价统计
class MeterQualityEvalStaticLocators:
    # 【查询条件】
    # 供电单位
    ORG_NO = (
...
# 电表质量评价明细
class MeterQualityEvalDetailLocators:
    # 【查询条件】
    # 供电单位
    ORG_NO = (
    ...
    # 【js操作】
    # 查询开始日期，删除readonly属性
    QUERY_START_DATE_JS = 'document.getElementById("startDateForMeterQualEvalD").removeAttribute("readonly");'
    # 查询结束日期，删除readonly属性
    QUERY_END_DATE_JS = 'document.getElementById("endDateForMeterQualEvalD").removeAttribute("readonly");'
