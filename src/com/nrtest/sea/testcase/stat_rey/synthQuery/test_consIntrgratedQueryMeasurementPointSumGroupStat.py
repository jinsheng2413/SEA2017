...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointSumGroupStat.py
@time:2019/2/27 14:14
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointSumGroupStatPage


# 统计查询→综合查询→单户综合查询--统计数据：总加组统计数据
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointSumGroupStatPage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointSumGroupStat_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:总加组统计数据
        """
