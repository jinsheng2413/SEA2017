...
class CostControlManagePageLocators:
 ...
 #终端地址
 QRY_TERMIAL_ADDR = (By.XPATH,"//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'终端地址')]/../div/input")
 #按
 ...
 #用户编号
 QRY_USER_NUM = (By.XPATH,"//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'用户编号')]/../div/input")
 #用户名称
 QRY_USER_NAME = (By.XPATH,"//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'用户名称')]/../div/input")
 #业务类型
 SEL_BUNIESS_CATA = (By.XPATH,"//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'业务类型')]/../div/div/input")
