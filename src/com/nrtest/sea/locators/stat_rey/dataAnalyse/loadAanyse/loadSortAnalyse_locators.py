...
@file: loadSortAnalyse_locators.py
@time: 2018/10/25 0025 15:25
@desc:
'''
...
class LoadSortAnalyseLocators:
    #【查询条件区】
    #开始日期
    QRY_START_DATE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'开始日期')]/../../div[1]/div[1]//input")
    #结束日期
    QRY_END_DATE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'结束日期')]/../../div[1]/div[1]//input")

    #用户类型
    QRY_USER_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'用户类型')]/../../div[1]/div[1]//input")
    QRY_USER_TYPE_VALUE = (
        By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'专变')]/../div[contains(text(),'%s')]")
    #排名数量
    QRY_RANKING_NUMBER = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'排名数量')]/../../div[1]/div[1]//input")
