...
from com.nrtest.sea.pages.base_app.interfaceMan.manualEdit_page import ManualEditPage
...
class Test_ManualEdit(TestCase, ManualEditPage):
    ...
    def setUpClass(cls):
        # 打开菜单（需要传入对应的菜单编号）
        menuPage = MenuPage.openMenu(InterfaceManager_data.para_ManualEdit)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(InterfaceManager_data.para_ManualEdit, valCheck=True))
