...
class MetclassfiyLocators:
    #【查询条件区】
    #模板名称
    QRY_TEMPLET_NAME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'模板名称')]/../../div[1]/div[1]//input")
    #电能表类型
    QRY_METER_TYPE = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'电能表类型')]/../../div[1]/div[1]//img")
    QRY_METER_TYPE_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'13版三相电能表')]/../div[contains(text(),'%s')]")
    #操作
    QRY_PERFORMER = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'操作')]/../../div[1]/div[1]//input")
