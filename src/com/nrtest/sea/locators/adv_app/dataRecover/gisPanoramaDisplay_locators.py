...
class GisPanoramaDisplayLocators:
    ...
    #逐日显示
    QRY_DAY_DISPLAY = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'逐日显示')]/../../div[1]/div[1]//input")
    QRY_DAY_DISPLAY_VALUE = (
    By.XPATH, "//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'是')]/../div[contains(text(),'%s')]")

    #查询时间
    QRY_QUERY_TIME = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'查询时间')]/../../div[1]/div[1]//input")
    #
