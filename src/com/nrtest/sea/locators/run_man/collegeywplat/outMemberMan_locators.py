...
class OutNameTroopLocators:
    ...
    # 【显示区】
    TAB_ONE = (By.XPATH,
               '(//*[text()=\'成员明细\']/ancestor::div[@class=\"x-grid3-viewport\"]//table[@class=\"x-grid3-row-table\"])[1]')
...
class OutNameTroopMemberLocators:
    ...
    # 【显示区】
    TAB_ONE = (
    By.XPATH, '(//*[text()=\'手机\']/ancestor::div[@class=\"x-grid3-viewport\"]//table[@class=\"x-grid3-row-table\"])[1]')
    TAB_ONE_VALUE = (By.XPATH, "//*[@class=\"x-grid3-row-table\"])[]//div[]")
