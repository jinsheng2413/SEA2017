...
class ValidPowerCutDetailLocators:
    ...
    # 当前是否停电
    QRY_WHETHER_POWER_CUT = (
        By.XPATH, '//label[contains(text(),"当前是否停电")]/../div/div/img')
    QRY_WHETHER_POWER_CUT_VALUE = (
        By.XPATH, '//div[@class="x-combo-list-inner"]/div[%s]')
    # 是否有效停电
    QRY_WHETHER_POWER_CUT_VALID = (
        By.XPATH, '//label[contains(text(),"是否有效停电")]/../div/div/img')
    QRY_WHETHER_POWER_CUT_VALID_VALUE = (
        By.XPATH, '//div[@class="x-combo-list-inner"]/div[%s]')
    # 是否补全
    QRY_COMPLEMENT = (
        By.XPATH, '//label[contains(text(),"是否补全")]/../div/div/img')
    QRY_COMPLEMENT_VALUE = (
        By.XPATH, '//div[@class="x-combo-list-inner"]/div[%s]')
    # 终端厂家
    QRY_TMNL_FACTORY = (
