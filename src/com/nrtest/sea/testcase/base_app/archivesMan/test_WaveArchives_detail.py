...
from com.nrtest.sea.pages.base_app.archivesMan.waveArchives_pages import WaveArchives_detail_Page
...
class TestWaveArchives_detail(TestCase, WaveArchives_detail_Page):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(ArchivesMan_data.waveArchives_detail_tab)
