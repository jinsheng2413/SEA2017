...
class TestDemo(unittest.TestCase, MetClockDayStaticPage):
    ...
    def setUpClass(cls):
        ...
        sleep(2)
        cls.driver.execute_script(MetClockDayStaticLocators.QUERY_DATE_JS)
    ...
    def query(self, para):
        ...
        self.sleep_time(2)
        # 校验
        result = self.assert_context(*MetClockDayStaticLocators.TABLE_DATA)
        self.assertTrue(result)

    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(ClockData.para_MetCheckClock, '电表时钟日统计'))
