...
#电压曲线
    #下拉菜单
    INPUTSEL_VOLTAGECURVE_GROUP = (By.XPATH,'//input[@class=" x-form-text x-form-field x-trigger-noedit  x-form-focus"]')
    #查询日期
...
#电流曲线
    ...
    #下拉菜单
    INPUTSEL_CURRENTCURVE_GROUP = (By.XPATH,'//input[@class=" x-form-text x-form-field x-trigger-noedit  x-form-focus"]')
    #查询日期
...
#功率曲线
    ...
    #下拉菜单
    INPUTSEL_POWERCURVE_GROUP = (By.XPATH,'//div[@class="x-form-field-wrap x-form-field-trigger-wrap  x-trigger-wrap-focus"]/input[2]')
    #查询日期
...
#功率因数曲线
    ...
    #查询日期
    INPUTDT_POWERFACTORCURVE_TIME = (By.XPATH,'//input[@class=" x-form-text x-form-field x-trigger-noedit x-form-focus"]')
    #查询按钮
