...
class ArchivesAnalysisOfAnomaly_count_locators:
    ...
    # 日期
    QRY_DATE = (By.XPATH,"(//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'日期')])[1]/../div[1]/div/input")
...
class ArchivesAnalysisOfAnomaly_detail_locators:
    ...
    # 【查询条件】
    #档案类型
    QRY_ARCHIVES_CATA = (By.XPATH,"//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'档案类型')]/../div/div/img")
    QRY_ARCHIVES_CATA_VALUE = (By.XPATH, "//div[@class=\"x-combo-list-inner\"]//div[contains(text(),'用户档案')]/../div[%s]")

    # 用户类型
    QRY_USER_CATA = (By.XPATH,"(//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//label[contains(text(),'用户类型')]/../div/div/img)[2]")
    QRY_USER_CATA_VALUE = (By.XPATH, "//div[@class=\"x-combo-list-inner\"]//div[contains(text(),'全部')]/../div[%s]")
    # 日期
    QRY_DATE = (By.XPATH,"//*[@id=\"statDateDetail\"]")

    # 【操作区】
    BTN_QRY = (By.XPATH,"(//div[@class=\"x-panel-body x-panel-body-noheader x-panel-body-noborder\"]//tbody[@class=\"x-btn-small x-btn-icon-small-left\"]//button[contains(text(),'查询')])[2]")
