...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointCurrentOverLimit.py
@time:2019/2/27 13:34
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointCurrentOverLimitPage


# 统计查询→综合查询→单户综合查询--统计数据：测量点电流越限统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointCurrentOverLimitPage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointCurrentOverLimit_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:测量点电流越限统计
        """
