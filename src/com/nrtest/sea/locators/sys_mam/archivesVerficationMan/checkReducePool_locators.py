...
class CheckReducePoolLocators:
    #【查询条件区】
    #申请日期
    QRY_APPLY_DATE = (By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'申请日期')]/../../div[1]/div[1]//input)[1]")
    #至
    QRY_APPLY_DATE_TO = (By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'申请日期')]/../../div[1]/div[1]//input)[2]")
    #工单状态
    QRY_WORK_STATUS = (By.XPATH, "//div[@class=\"x-form-item \"]//label[contains(text(),'工单状态')]/../../div[1]/div[1]//input")
