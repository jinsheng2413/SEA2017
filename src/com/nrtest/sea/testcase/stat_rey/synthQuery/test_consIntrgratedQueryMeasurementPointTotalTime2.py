...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointTotalTime2.py
@time:2019/2/27 14:01
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointTotalTime2Page


# 统计查询→综合查询→单户综合查询--统计数据：测量点功率因数区段累计时间统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointTotalTime2Page):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointTotalTime2_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:测量点功率因数区段累计时间统计
        """
