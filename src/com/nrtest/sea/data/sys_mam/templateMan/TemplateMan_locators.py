...
#新增页面
    ...
    #确定按钮
    BTN_UNIT_SURE = (By.XPATH,'//div[@class=" x-window x-window-noborder x-window-plain x-resizable-pinned"]//button[contains(text(),"确定")]')
    #终端类型
...
#关闭保存成功窗口
    ...
    BTN_TAB = (By.XPATH,'//div[@class=\" x-window x-window-noborder x-resizable-pinned\"]/div[1]/div/div/div[1]/div[1]')
#确定删除
    #“是”按钮
