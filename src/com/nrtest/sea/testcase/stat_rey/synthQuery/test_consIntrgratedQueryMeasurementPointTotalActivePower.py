...
"""
@author: js
@file:test_consIntrgratedQueryMeasurementPointTotalActivePower.py
@time:2019/2/27 14:04
@desc:
"""
...
from com.nrtest.sea.pages.stat_rey.synthQuery.consIntegratedQuery_page import \
    ConsIntrgratedQueryMeasurementPointTotalActivePowerPage


# 统计查询→综合查询→单户综合查询--统计数据：测量点总及分相有功功率统计
@ddt
class TestMeansurementPointVoltage(TestCase, ConsIntrgratedQueryMeasurementPointTotalActivePowerPage):
    ...
    @data(*DataAccess.getCaseData(SynthQuery_data.consIntrgratedQuery_para,
                                  SynthQuery_data.consIntrgratedQueryMeasurementPointTotalActivePower_tab))
    def test_query(self, para):
        """统计查询→综合查询→单户综合查询:测量点总及分相有功功率统计
        """
