...
class EleParaManLocators:
    ...
    #是否已生成参数
    QRY_OR_COMEINTO_PARA_ONE = (By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'是否已生成参数')]/../../div[1]/div[1]//input)[1]")
    QRY_OR_COMEINTO_PARA_ONE_VALUE = (
        By.XPATH, "(//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'新增')]/../div[contains(text(),'%s')])[2]")
    QRY_OR_COMEINTO_PARA_TWO = (By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'是否已生成参数')]/../../div[1]/div[1]//input)[2]")
