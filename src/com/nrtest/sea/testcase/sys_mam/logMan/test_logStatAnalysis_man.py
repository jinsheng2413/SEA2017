...
class TestLogStatAnalysis(unittest.TestCase, LogStatAnalysis_man_Page):
    ...
    def setUpClass(cls):
        ...
        clickTabPage(LogEdit_data.logStatAnalysis_tab_man)
        sleep(2)
        cls.exec_script(cls, LogStatAnalysis_man_Locators.START_DATE_JS)
        cls.exec_script(cls, LogStatAnalysis_man_Locators.END_DATE_JS)
    ...
    def query(self, para):
        ...
        self.sleep_time(2)
        # 校验
        result = self.assert_context(*LogStatAnalysis_man_Locators.TAB_ONE)
