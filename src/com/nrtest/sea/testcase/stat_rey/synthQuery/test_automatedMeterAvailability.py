...
@file: test_automatedMeterAvailability.py
...
class TestAutomatedMeterAvailability(TestCase, AutomatedMeterAvailabilityPage):
    ...
    def setUpClass(cls):
        ...
        menuPage.clickTabPage(SynthQuery_data.AutomatedMeterAvailability_tabName)
    ...
    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(SynthQuery_data.AutomatedMeterAvailability_para,
                                  SynthQuery_data.AutomatedMeterAvailability_tabName, valCheck=True))
