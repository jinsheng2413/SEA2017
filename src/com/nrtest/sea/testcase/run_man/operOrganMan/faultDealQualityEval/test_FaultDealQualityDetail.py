...
# 故障处理质量明细
@ddt
class TestDemo(unittest.TestCase, FaultDealQualityDetailPage):
    ...
    def setUpClass(cls):
        ...
        sleep(2)
        cls.driver.execute_script(FaultDealQualityDetailLocators.QUERY_DATE_JS)
    ...
    def query(self, para):
        ...
        self.sleep_time(2)
        # 校验
        result = self.assert_context(*FaultDealQualityDetailLocators.TABLE_DATA)
        self.assertTrue(result)

    @BeautifulReport.add_test_img()
    @data(*DataAccess.getCaseData(OperOrganManData.para_FaultDealQualityEval, '故障处理质量明细'))
