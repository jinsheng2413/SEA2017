...
class PrePaidStatus_Locators:
    ...
    QRY_CONTROL_TYPE_VALUE_TWO = (By.XPATH, "(//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'主站远程费控')]/..)[2]/div[%s]")
    #开始时间
    ...
    QRY_CONTROL_TYPE_VALUE_ONE = (By.XPATH, "(//div[@class=\"x-combo-list-inner\"]//*[contains(text(),'主站远程费控')]/..)[1]/div[%s]")
