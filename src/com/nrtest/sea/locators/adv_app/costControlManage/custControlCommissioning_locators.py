...
class CustControlCommissioning_locators:
    ...
    # 下发状态
    QRY_PROVIDE_STATE = (
        By.XPATH, "//div[@class=\"x-form-item \"]/label[contains(text(),'下发状态')]/../div[1]/div/img")
    ...
    # 终端地址
    QRY_TERMIAL_ADDR = (
        By.XPATH, "//div[@class=\"x-form-item \"]/label[contains(text(),'终端地址')]/../div/input")
    # 用户编号
    QRY_CONS_NO = (
        By.XPATH, "//div[@class=\"x-form-item \"]/label[contains(text(),'用户编号')]/../div/input")
    # 用户名称
    QRY_CONS_NAME = (
        By.XPATH, "//div[@class=\"x-form-item \"]/label[contains(text(),'用户名称')]/../div/input")
    # 按
    SELR_ARRANGE = (
    ...
    TAB_ONE_ALL_CLASS = (
        By.XPATH, '(// div[@class =\"x-grid3-row-checker\"])[1]/../../../td[10]/div/a')
