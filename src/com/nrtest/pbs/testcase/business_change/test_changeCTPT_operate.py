...
@file: test_changeCTPT_operate.py
@time: 2019-03-13 10:54
@desc:
"""
...
from com.nrtest.pbs.page.business_change.changeCTPT_page import ChangeCTPTOperatePage
...
# 业务变更→换CT/PT:换CTPT操作
@ddt
class TestChangeTableOperate(TestCase, ChangeCTPTOperatePage):
    @classmethod
    def setUpClass(cls):
        # 打开菜单（需要传入对应的菜单编号）
        menuPage = MenuPage.openMenu(BusinessChange_data.ChangeCTPT_para)
