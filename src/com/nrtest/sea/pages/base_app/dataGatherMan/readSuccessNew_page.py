...
class GatherSuccessRatePageNew(Page):
    # tab_name
    def inputChk_tab_name(self, value):
        self.clickTabPage(value)

    # tab_name2
    def inputChk_tab_name2(self, value):
        self.clickTabPage(value)
    ...
    # 终端类型2
    def inputSel_tmnl_type2(self, options):
        # self.clean_label(options)
        # self.selectDropDown(options)
        self.selectCheckBox(options, is_multi_tab=True, is_multi_elements=True)
    ...
    # # 采集成功率→采集成功率统计
    # class GatherSuccessRateStatPageNew(Page):
    #     # 数据类型
    #     def inputChk_data_type(self, options):
    #         self.clickRadioBox(options, is_multi_tab=True, is_multi_elements=True)
    #
    ...
    #
    # 通信方式
    def inputSel_comm_mode2(self, option):
...
# # 采集成功率→采集成功率明细
# class GatherSuccessRateDetailPageNew(Page):
#     # 用户类型
#     def inputSel_cons_type(self, options):
...
# 采集成功率→连续抄表失败明细
# class ContinuousFalseDetailPageNew(Page):
# # 用户类型
# def inputSel_cons_type(self, options):
#     self.selectCheckBox(options, is_multi_tab=True, is_multi_elements=True, unchecked_cls=True)
#
...
# class GatherSuccessRateTimePageNew(Page):
#     # 数据类型
#     def inputChk_data_type(self, options):
#         self.clickRadioBox(options, is_multi_tab=True, is_multi_elements=True)
