...
class LocalFeiManageExeCount_dis_count_Page(Page):
    ...
    def inputSel_work_cata(self, index):
        ...
        locator = self.get_select_locator(
            LocalFeiManageExeCount_dis_count_Locators.QRY_WORK_CATA_VALUE, index)
        # print(locator)
        self.click(*locator)
    ...
    def inputSel_feiUserCata(self, index):
        ...
        locator = self.get_select_locator(
            LocalFeiManageExeCount_dis_count_Locators.QRY_FEI_USER_CATA_VALUE, index)
        # print(locator)
        self.click(*locator)
    ...
    def inputStr_receive_time(self, value):
        self.input(
            value, *LocalFeiManageExeCount_dis_count_Locators.QRY_RECEIVE_DATE)
    ...
    def btn_work_success_all(self):
        self.click(
            *LocalFeiManageExeCount_dis_count_Locators.TAB_ONE_WORK_SUECESS_ALL)

    # 执行成功工单总数
    def btn_work_fail_all(self):
        self.click(
            *LocalFeiManageExeCount_dis_count_Locators.TAB_ONE_WORK_FAIL_ALL)
...
class LocalFeiManageExeCount_dis_detail_Page(Page):
    ...
    def inputSel_work_cata(self, index):
        ...
        locator = self.get_select_locator(
            LocalFeiManageExeCount_dis_detail_Locators.QRY_WORK_CATA_VALUE, index)
        # print(locator)
        self.click(*locator)
    ...
    def inputSel_feiUserCata(self, index):
        ...
        locator = self.get_select_locator(
            LocalFeiManageExeCount_dis_detail_Locators.QRY_FEI_USER_CATA_VALUE, index)
        # print(locator)
        self.click(*locator)
    ...
    def inputSel_execute_state(self, index):
        ...
        locator = self.get_select_locator(
            LocalFeiManageExeCount_dis_detail_Locators.QRY_EXECUTE_STATE_VALUE, index)
        # print(locator)
        self.click(*locator)
    ...
    def inputStr_receive_time(self, value):
        self.input(
            value, *LocalFeiManageExeCount_dis_detail_Locators.QRY_RECEIVE_DATE)

    # 结束时间
    def inputStr_end_time(self, value):
        self.input(
            value, *LocalFeiManageExeCount_dis_detail_Locators.QRY_END_DATE)

    # 工单编号
    def inputStr_work_num(self, value):
        self.input(
            value, *LocalFeiManageExeCount_dis_detail_Locators.QRY_EMPLOYEE_NUM)

    # 用户编号
    def inputStr_user_num(self, value):
        self.input(
            value, *LocalFeiManageExeCount_dis_detail_Locators.QRY_USER_NUM)
