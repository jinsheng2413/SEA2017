...
class PrePaidStatus_Locators:
    ...
    # 开始时间
    QRY_START_TIME_ONE = (
        By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'从')]/../../div[1]/div[1]//input)[1]")
    QRY_START_TIME_TWO = (
        By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'从')]/../../div[1]/div[1]//input)[2]")
    # 结束时间
    QRY_END_TIME_ONE = (
        By.XPATH, "(//div[@class=\"x-form-item \"]//label[contains(text(),'到')]/../../div[1]/div[1]//input)[1]")
    QRY_END_TIME_TWO = (
    ...
    # 【js区】
    # 开始时间，删除readonly属性
    START_DATE_TWO_JS = "document.getElementsByName('dateFieldFrom')[0].removeAttribute(\"readonly\");"
    START_DATE_ONE_JS = "document.getElementsByName('dateField_1')[0].removeAttribute(\"readonly\");"
    # 结束时间，删除readonly属性
    END_DATE_TWO_JS = "document.getElementsByName('dateFieldTo')[0].removeAttribute(\"readonly\");"
    END_DATE_ONE_JS = "document.getElementsByName('dateField')[0].removeAttribute(\"readonly\");"
